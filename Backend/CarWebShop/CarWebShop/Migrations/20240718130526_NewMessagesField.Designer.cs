...
namespace CarWebShop.Migrations
{
    ...
    [Migration("20240718130526_NewMessagesField")]
    partial class NewMessagesField
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarWebShop.Models.Messages", b =>
                {
                    ...
                    b.HasKey("SenderID", "ReceiverID", "AdverID", "MessageID");
            ...
            modelBuilder.Entity("CarWebShop.Models.Messages", b =>
                {
                    ...
                    b.HasOne("CarWebShop.Models.User", "Receiver")
                        .WithMany("ReceivedMessages")
                        .HasForeignKey("ReceiverID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CarWebShop.Models.User", "Sender")
